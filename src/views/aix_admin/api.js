...
export function uploadFlowchart (data) {
  return request.post(`http://10.214.211.208:8002/models/checkModel`, data);
}
...
export function getAvailableModels (params) {
  return request.get(`http://10.214.211.208:8002/getInfo/getInfoByTaskType`, {
    params
  });
}
// export function getAvailableModels(params) {
...
export function getFlowchartDetails (params) {
  ...
  return request.get(`http://10.214.211.208:8002/flowchart/queryById`, { params });

}

export function getFlowchartProcess (flowchartId) {
  return request.get(
    `http://10.214.211.205:8080/multiple_task/` + flowchartId + `/list`
  );
}
...
export function fetchPredictingTasks (params) {
  return request.post(
    `http://10.214.211.208:8002/predict/queryPredictTaskByFlowchartId`,
    params
  );
}
...
export function createPredictingTask (data) {
  return request.post(
    `http://10.214.211.208:8002/predict/createAixTaskForPredict`,
    data
  );
}
...
export function downloadModel (params) {
  ...
  return request.get(`http://10.214.211.208:8002/download/wrapper`, { params });
}

export function downloadMirror (params) {
  return request.get(`http://10.214.211.208:8002/predict/createAixTaskForPredict`, { params });
}

export function deleteFlowchart (data) {
  return request.post(`http://10.214.211.208:8002/flowchart/delete`, data);
}
